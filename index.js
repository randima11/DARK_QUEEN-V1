...
console.log("🧚‍♂️CONNECTIING DARK_QUEEN-V1🧚‍♂️");
...
console.log('pluging installing✅')
const path = require('path');
...
console.log('🧚‍♂️DARK_QUEEN🧚‍♂️ CONNECTED TO WHATSAPP ✅')

let up = `╭──────────────⊷❒

- *🩷සාදරයෙන් පිලිගන්නවා DARK_QUEEN-V1 WHATSAPP BOT වෙත.*
⁠⁠⁠⁠
⁠⁠⁠⁠┗━┫*⚬°❀𝐌❀°⚬*┣━⁠⁠⁠⁠✾

- *🩷DARK_QUEEN-V1 යනූ සීඝ්‍රයෙන් වර්ධනය වන Whatsapp රොබෝවෙකි.*
⁠⁠⁠⁠
┗━┫*⚬°❀𝐀❀°⚬*┣━⁠⁠⁠⁠✾
...
⁠⁠⁠⁠⁠⁠⁠⁠⁠⁠⁠⁠┗━┫*⚬°❀𝐀❀°⚬*┣━⁠⁠⁠⁠✾
⁠⁠⁠⁠╰──────────────⊷❒ `;
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/v1k9r3.jpg` }, caption: up })
...
if (config.AUTO_BIO === 'true'){
               await
conn.updateProfileStatus(`🩷ꜱʀɪ-ʟᴀɴᴋᴀɴ ᴍᴏꜱᴛ ꜱᴘᴇᴇᴅ & ʙᴇꜱᴛ ᴍᴜʟᴛɪ ᴅᴇᴠɪᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ.㊗️ ᴛʜɪꜱ ʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ɪꜱ ᴍᴀɴɪꜱʜᴀ ꜱᴀꜱᴍɪᴛʜᴀ.🩷`)
}
...
console.error("[PLUGIN ERROR⚠️] " + e);
}
}
}
...
app.get("/", (req, res) => {
res.send("HEY, DARK_QUEEN START✅");
});
app.listen(port, () => console.log(`DARK_QUEEN Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 4000);
