...
console.log("Connecting DARK_QUEEN 🉐...");
...
console.log('create by manisha sasmitha 🉐')
...
- *🩷DARK_QUEEN පිළිබද සම්පූර්ණ අවබෝධයක් ලබා ගැනීමට .help යන විධානය භාවිතා කරන්න.*
...
app.get("/", (req, res) => {
res.send("hey, DARK QUEEN started🉐");
});
