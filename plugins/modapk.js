...
var N_FOUND =''
if(config.LANG === 'SI') N_FOUND = "*I couldn't find anything :(*"

var urlneed =''
if(config.LANG === 'SI') urlneed = "It downloads mod apps from androidapksfree."

var imgmsg =''
if(config.LANG === 'SI') imgmsg = "```Please write a few words!```"
